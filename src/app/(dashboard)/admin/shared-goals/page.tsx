    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          {cycle ? cycle.name : "No active cycle"} · Push a departmental KPI to multiple employees at once
        </p>
      </div>
      ...
      {!cycle ? (
        <Card>
          <CardContent className="py-12 text-center text-muted-foreground">
            No active goal cycle. Activate a cycle before pushing shared goals.
          </CardContent>
        </Card>
      ) : (
        <PushSharedGoalForm
